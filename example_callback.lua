--[[
----
----Created Date: 1:16 Tuesday June 29nd 2023
----Author: JustGod
----Made with ❤
----
----File: [example_callback]
----
...
local singleton = Class.singleton("ASingletonClass", function(class)

    ---@class ASingletonClass: BaseObject
    local self = class;
...
end, "I'm a singleton", "I'm a singleton too");

print(("Testing singleton [ name: %s, some_variable: %s ]"):format(singleton.name, singleton.some_variable));